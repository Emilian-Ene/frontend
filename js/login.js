...
document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch('https://topc-backend.onrender.com/api/auth/google-login', {
      method: 'POST',
      headers: {
  ...
  loginForm.addEventListener('submit', async function (e) {
    ...
    try {
  const res = await fetch('https://topc-backend.onrender.com/api/auth/login', {
        method: 'POST',
  ...
  signupForm.addEventListener('submit', async function (e) {
    ...
    try {
  const res = await fetch('https://topc-backend.onrender.com/api/auth/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email, password }),
      });
